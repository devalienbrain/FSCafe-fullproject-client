  ...
  return (
    <div className="min-h-screen flex justify-center items-center text-left">
      <div className="flex flex-col space-y-11">
        ...
        <h1 className="text-2xl text-red-900 font-bold italic"> e r r o r !</h1>
        <Link to={"/"}>
          <div className="flex gap-2 text-sm bg-black py-2 px-5 rounded-xl text-white font-semibold">
            <span className=" italic ">Click to go home</span>
